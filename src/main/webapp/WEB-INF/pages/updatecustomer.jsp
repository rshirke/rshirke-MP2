...
<html>
    <head>
        ...
        <title>Customer Update JSP Page</title>
    </head>
    <body>
        <h1>Kindly update the given customer</h1>
        <%-- 
...
<c:if test="${not empty requestScope.violations}">
    ...
    <div>
        ...
        <input type="number" name="customerId" id="customer" value="${customer.id}" readonly="readonly"/>
    </div>
    <div>
    ...
    <input type="submit" name="submitCustomer" value="Update" id="submitCustomer"/>
</form>
    </body>
</html>
